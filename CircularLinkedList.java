...
public static void main(String[] args) {
 ...
 System.out.println("Adding element 6 to the Empty list");
 last = addToEmpty(last, 6);
 
 System.out.println("Adding element 8 at the last position of the linked list");
 last = addEnd(last, 8);
 
 System.out.println("Adding element 2 at the First position");
 last = addFront(last, 2);

 System.out.println("Adding element 2 after 10 at the Last position");
 last = addAfter(last, 10, 2);
 traverse(last);

 System.out.println("\nDeleting element 8 from the Last position");
 deleteNode(last, 8);
 traverse(last);
}
}