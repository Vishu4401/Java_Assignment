...
class StudentPerformances {
		...
		String stu_id;
		int score;
		public StudentPerformances() {
			this(" ", " ", 0);
		}
		public StudentPerformances(String initName, String initId, int initScore) {
			name = initName;
			stu_id = initId;
			score = initScore;
		}
	...
	public class Main {
		public void main(String[] args) {
			...
			StudentPerformances stu = new StudentPerformances();
			StudentPerformances max = new StudentPerformances();
			StudentPerformances min = new StudentPerformances(" ", " ", 100);
			for (int i = 0; i < n; i ++) {
				stu.name = in.next();
				stu.stu_id = in.next();
